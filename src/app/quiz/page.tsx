...
function Page() {
  ...
  return (
    ...
    <h1 className="flex pb-3 pt-3 items-center justify-center text-yellow-400 text-2xl font-bold">Play the track and pick</h1>
    <h1 className="flex items-center justify-center text-yellow-400 text-2xl font-bold"> the right song name</h1>
    </div>
   
    <div>
        <GuessSong previewUrl={tracks[currentQuestion].preview_url} options={options} correctOption={tracks[currentQuestion].name} nextQuestion={nextQues} score={score} />
